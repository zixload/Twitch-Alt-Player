...
def etape_plein_ecran_videos(etat):
    """Le plein ecran depuis la vue des videos : l'image couvre-t-elle l'ecran ?
...
def main():
    ...
    if not STATIQUE:
        etapes += [
            ...
            (u'plein ecran, vue des videos', lambda: etape_plein_ecran_videos(etat)),
